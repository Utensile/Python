...
def open_serial_port():
    ...
    try:
        ...
        serial_label_font = ('Helvetica', 100)
        serial_label_color = 'white'
        alt_label_font = ('Helvetica', 50, "bold")
        crimson = '#DC143C'
        gray="#8C92AC"
        ...
        button = tk.Button(window, text="Activate", font=("Helvetica", 50, "bold"), bg=gray, foreground='white', relief='raised', bd=20, command=Launch, width=int(root.winfo_screenwidth()/2))
        button.pack(pady=20)
        launch = ttk.Label(window, text="Waiting for Activation...", font=('Helvetica', 40), foreground=gray, background="#282424")
        launch.pack(anchor='center', pady=20)

        maxhLabel = ttk.Label(window, text="Max Height: 0.00 m", font=('Helvetica', 30, "bold"), foreground="#D89216", background="#282424")
        ...
        para_button.place(x=root.winfo_screenwidth()/3.2, y=root.winfo_screenheight()*0.89)
        stop_button.place(x=root.winfo_screenwidth()/1.6, y=root.winfo_screenheight()*0.89)
