...
def open_serial_port():
    ...
    try:
        ...
        para_button.place(x=root.winfo_screenwidth()/3, y=root.winfo_screenheight()*0.89)
        stop_button.place(x=root.winfo_screenwidth()/1.8, y=root.winfo_screenheight()*0.89)
